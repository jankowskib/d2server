...
//ITEM RELATED
EXFUNCPTR(D2COMMON, AllocInventory, Inventory*, __stdcall, (D2PoolManager *pMemPool, UnitAny *pOwner), -10976)
EXFUNCPTR(D2COMMON, AllocTradeInventory, int, __stdcall, (D2PoolManager *pMemPool, UnitAny *pPlayer, UnitAny *pTrader, BOOL *bNoRoom), -10339)
...
EXFUNCPTR(D2COMMON, LoadAct, Act*, __stdcall, (DWORD ActNumber, DWORD InitSeed, DWORD Unk0, Game *pGame, DWORD DiffLvl, D2PoolManager* pMemPool, DWORD TownLevelId, DWORD Func1, DWORD Func2), -10669)
