...
extern string wcfgClansURL;
extern string wcfgConfigFile;
extern string wcfgUpdateURL;
extern string wcfgGSName;
extern list<string> wcfgAdmins;
extern map<string,BYTE> ColorSet;
extern vector<DWORD> Pointers;
extern map<DWORD, DWORD> Specers;
