...
;D2 export entrys
D2COMMON_11166_GetMyPosition dd 0 ; 1.13d
D2COMMON_10691_GetLevelIdFromRoom dd 0 ; 1.13d
D2COMMON_10846_GetUnitRoom dd 0 ; 1.13d
D2COMMON_GetNextFreeSubTile_10716 dd 0 ;1.13d
D2COMMON_ChangeCurrentMode_10193 dd 0 ; 1.13d
D2COMMON_GetPortalFlags_10040 dd 0 ; 1.13d
D2COMMON_SetPortalFlags_10033 dd 0 ; 1.13d
D2COMMON_UpdateRoomWithPortal_10907 dd 0 ; 1.13d
D2Common_10156_GetQuestFlag dd 0 ; 1.13d
D2Common_10595_SetQuestFlag dd 0 ; 1.13d

D2GAME_0x59980 dd 0 ; 1.13d
D2GAME_0xCDE20_SpawnSuperUnique dd 0 ; 1.13d
D2GAME_0x1340_CheckXYOccupy dd 0 ; 1.13d
D2GAME_0x6FE10_CreateUnit dd 0 ; 1.13d
D2GAME_0x15F40_ConnectPortal dd 0 ;1.13d
D2GAME_0X1606D dd 0 ; 1.13d unused
D2GAME_0x5A000_RemoveMonsterCorpse dd 0 ; 1.13d
D2GAME_0xC8850_Baal_AI dd 0 ; 1.13d
D2GAME_0x4EAD0_Mephisto_AI dd 0 ; 1.13d
D2GAME_0x31920_Diablo_AI dd 0 ; 1.13d

D2GAME_0xF1380_StallSomeTime dd 0 ; 1.13d
D2GAME_0xB1A00_GetAreaSpawnUnitNum dd 0 ; 1.13d
D2GAME_0xF1430_UseASkill dd 0 ; 1.13d
D2GAME_0xC8D70_SpawnAMonster dd 0 ; 1.13d
D2GAME_sgptDataTables dd 0 ; 1.13d
D2GAME_0x14C0_GetMonstatsTxtRec dd 0 ; 1.13d

D2COMMON_10142_GetLevelRec dd 0 ; 1.13d
...
; Check in ACT5 town
                push    edi
                call    D2COMMON_10846_GetUnitRoom
                push    eax
...
arg_8           = dword ptr  0Ch
                ...
                push    edx
                push    esi
                call    D2COMMON_GetNextFreeSubTile_10716
                test    eax, eax
                ...
                push    eax
                mov     ecx, esi
                call    D2GAME_0x1340_CheckXYOccupy1
...
loc_10018AA0:
                ...
                mov     edx, 3Ch
                mov     ecx, 2
                call    D2GAME_0x6FE10_CreateUnit
                mov     esi, eax
                mov     eax, [esi+14h]
                push    1
                push    esi
                mov     [eax+4], bl
                call    D2COMMON_ChangeCurrentMode_10193
                push    6Dh
                push    ebx
                push    esi
                push    ebp
                call    D2GAME_0x15F40_ConnectPortal
                push    esi
                call    D2COMMON_GetPortalFlags_10040
                or      eax, 3
                push    eax
                push    esi
                call    D2COMMON_SetPortalFlags_10033

                push    0
                push    edi
                call    D2COMMON_UpdateRoomWithPortal_10907 ; 1.13d
                                push    0
                push    esi
                call    D2COMMON_10846_GetUnitRoom
                push    eax
...
;       mov     dword ptr [edx+68h], 0 ; Spawn Counter
        ...
        ; ³õÊ¼»¯Ëæ»úÊýÖÖ×Ó£¬ÓÃÓÚËæ»úSpawn¹ÖÎï
        push            esi
        push            edx
        push            ecx
        call            GetExtendGameInfoStructPtr
...
; Ê×ÏÈ´´½¨Ò»¸öËæ»úÊý£¬È»ºó¾ö¶¨ÊÇSpawnÒ»¸öËæ»ú¹ÖÎï£¬»¹ÊÇ¼ÌÐøÔ­À´µÄMephisto_AI
        push    ecx     ; save ecx
        push    edx     ; save edx
...
call_orig_Mephisto_AI:
        mov eax,[esp+4]
        push eax
        call D2GAME_0x4EAD0_Mephisto_AI
        ret 4
UberMephisto_AI endp

UberDiablo_AI proc
; Ê×ÏÈ´´½¨Ò»¸öËæ»úÊý£¬È»ºó¾ö¶¨ÊÇSpawnÒ»¸öËæ»ú¹ÖÎï£¬»¹ÊÇ¼ÌÐøÔ­À´µÄDiablo_AI
        push    ecx     ; save ecx
        push    edx ; save edx
...
Meph_6FC886D9:
                ...
                mov     eax, 1          ; ±¾´Î¼ì²éÀàÐÍ£¬1=monster
                mov     edx, ebx        ; ptGame
                mov     [esp+40h+var_28], 0
                call    D2GAME_0xB1A00_GetAreaSpawnUnitNum
                mov     ecx, MaxSpawnNum_M ; ÏàÓ¦ÄÑ¶ÈÏÂµÄAI Par2£¬¸ÃAreaµÄSpawn×î´óÊýÄ¿
                cmp     [esp+38h+var_28], ecx ; Spawn×î´óÊýÄ¿
                jge     Meph_6FC8874F
                ...
                add     edx, ecx
                mov     [esi+64h], edx  ; ¸üÐÂÏÂÒ»¸öSpawnµÄÊ±¼ä
                mov     eax, StallTime_M ; ÏàÓ¦ÄÑ¶ÈÏÂµÄAI Par2£¬Í£¶ÙÊ±¼ä
                push    eax
                mov     eax, ebx
                call    D2GAME_0xF1380_StallSomeTime
                mov                     eax,1
                jmp                     Meph_over
...
Diablo_6FC886D9:
                ...
                mov     [esp+40h+var_28], 0
                call    D2GAME_0xB1A00_GetAreaSpawnUnitNum
                mov     ecx, MaxSpawnNum_D ; ÏàÓ¦ÄÑ¶ÈÏÂµÄAI Par2£¬¸ÃAreaµÄSpawn×î´óÊýÄ¿
                cmp     [esp+38h+var_28], ecx ; Spawn×î´óÊýÄ¿
                jge     Diablo_6FC8874F
...
corpse_found:
        ...
        push ecx
        push ecx
        call D2GAME_0x5A000_RemoveMonsterCorpse
        pop ecx
        pop ebx
        jmp loc_6FC859E6
monster_found:
...
MySpawnAMonster proc
        ...
        push edi
        call D2COMMON_10846_GetUnitRoom ; GetUnit_hRoom
        push eax ; hRoom
...
;¸øsgptDataTables´ò²¹¶¡£¬¶Ô¶àÈËÓÎÏ·µÄTC NoDrop½øÐÐÔ¤¼ÆËã
...
UberQuestPatchInit proc
        ...
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_GetNextFreeSubTile_10716,eax
        
        push 10193
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_ChangeCurrentMode_10193,eax
        
        push 10040
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_GetPortalFlags_10040,eax
        
        push 10033
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_SetPortalFlags_10033,eax
        
        push 10907
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_UpdateRoomWithPortal_10907,eax ; 1.13d

        push 10846
        push esi
        call ebx; GetProcAddr
        mov D2COMMON_10846_GetUnitRoom,eax
        ...
        mov eax,edx
        add eax,1340h
        mov D2GAME_0x1340_CheckXYOccupy,eax
        
        mov eax,edx
        add eax,06FE10h
        mov D2GAME_0x6FE10_CreateUnit,eax
        
        mov eax,edx
        add eax,15F40h
        mov D2GAME_0x15F40_ConnectPortal,eax
        ...
        mov eax,edx
        add eax, 05A000h
        mov D2GAME_0x5A000_RemoveMonsterCorpse,eax ;6FC43C40
        
        mov eax,edx
        add eax,0C8850h
        mov D2GAME_0xC8850_Baal_AI,eax ; 6FC4BC80

        mov eax,edx
        add eax,4EAD0h
        mov D2GAME_0x4EAD0_Mephisto_AI,eax ; 6FCF7BD0

        mov eax,edx
        add eax,031920h
        mov D2GAME_0x31920_Diablo_AI,eax ; 6FCA5AA0

        mov eax,edx
        add eax,0F1380h
        mov D2GAME_0xF1380_StallSomeTime,eax ; 6FD10CF0

        mov eax,edx
        add eax,0B1A00h
        mov D2GAME_0xB1A00_GetAreaSpawnUnitNum,eax ; 6FCE2650

        mov eax,edx
        add eax,0F1430h
        mov D2GAME_0xF1430_UseASkill,eax ; 6FD10DB0

        mov eax,edx
        add eax,0C8D70h
        mov D2GAME_0xC8D70_SpawnAMonster,eax ; 6FD0F870

        mov eax,edx
        add eax,0F8260h ; 1.13d 0F8288h
        mov D2GAME_sgptDataTables,eax ; 6FD18288
        
        mov eax,edx
        add eax,14C0h
        mov D2GAME_0x14C0_GetMonstatsTxtRec,eax ; 6FC21180
        
        mov eax,edx
        add eax,0C04F0h
        mov D2GAME_0C04F0_DeleteTimer,eax ; 6FC90C50 1.13d
...
D2GAME_0x1340_CheckXYOccupy1 proc
        arg_0= dword ptr  0Ch
        ...
        mov     eax, ecx
        mov     ebx, edx
        call    D2GAME_0x1340_CheckXYOccupy
        pop     ebx
        pop     edi
        retn    4
D2GAME_0x1340_CheckXYOccupy1 endp
