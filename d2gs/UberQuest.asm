...
D2COMMON_11048 dd 0
D2COMMON_11084 dd 0
D2Common_10753_GetQuestFlag dd 0
D2Common_10930_SetQuestFlag dd 0

D2GAME_0X235C0 dd 0
D2GAME_0XEC7E0_SpawnSuperUnique dd 0
D2GAME_0X1DF0 dd 0
D2GAME_0XC09E0 dd 0
D2GAME_0X109F0 dd 0
...
UberQuestInited:                
                ...
                push    eax
                push    esi ; ptUnit
                call    D2COMMON_10056_GetMyPosition
                mov     ecx, [esp+0Ch]
...
loc_10018DFC:
                ...
                mov     edx,0
                call    D2GAME_0XEC7E0_SpawnSuperUnique
...
MySpawnAMonster proc
	...
	push edi
	call D2COMMON_10933 ; GetUnit_hRoom
	push eax ; hRoom
...
UberQuestPatchInit proc
	...
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_10491,eax
	
	push 10572
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_10572,eax
	
	push 11160
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_11160,eax
	
	push 11048
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_11048,eax
	
	push 11084
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_11084,eax
	
	push 10933
	push esi
	call ebx; GetProcAddr
	mov D2COMMON_10933,eax
	
	push 10753
	push esi
	call ebx; GetProcAddr
	mov D2Common_10753_GetQuestFlag,eax
	...
	mov eax,edx
	add eax,1DF0h
	mov D2GAME_0X1DF0,eax
	
	mov eax,edx
	add eax,0C09E0h
	mov D2GAME_0XC09E0,eax
	
	mov eax,edx
	add eax,109F0h
	mov D2GAME_0X109F0,eax
	
	mov eax,edx
	add eax,235C0h
	mov D2GAME_0X235C0,eax
	
	mov eax,edx
	add eax,0EC7E0h
	mov D2GAME_0XEC7E0_SpawnSuperUnique,eax
